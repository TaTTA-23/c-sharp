/*
Use o Visual Studio Code para desenvolver 
um aplicativo de console em C# que usa 
loops foreach para acessar dados da matriz.
Use instruções if para avaliar condições e 
criar ramificações de código.
*/
